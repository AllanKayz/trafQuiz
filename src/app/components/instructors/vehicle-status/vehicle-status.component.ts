...
@Component({
    ...
    <div class="vehicle-status-container fade-in">
      ...
      <div class="vehicle-grid" *ngIf="assignedVehicles().length > 0; else noVehicles">
        <mat-card *ngFor="let v of assignedVehicles()" class="vehicle-card">
          <mat-card-header>
          ...
          <mat-card-content>
            ...
            <p class="notes" *ngIf="v.notes">{{v.notes}}</p>
          </mat-card-content>
          <mat-card-actions>
