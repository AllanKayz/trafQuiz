...
export class TraffiquizService implements OnDestroy {
  ...
  /** Computed Maps for O(1) lookups in table views */
  ...
  public tableInstructors = computed(() => {
    ...
    return this.instructorsSignal().map(instructor => ({
      ...
      specialization: specMap.get(instructor.specialization_id || -1) || 'N/A',
      certification: certMap.get(instructor.certification_id || -1) || 'N/A',
