...
ipcMain.handle("get-dashboard-stats", async (event, params) => {
  try {
    ...
    if (role === "admin") {
      ...
      // Optimize: Parallelize independent aggregate queries and use index-friendly date comparisons
      ...
      if (instructorId) {
        ...
        // Optimize: Parallelize independent instructor queries and use index-friendly date comparisons
      ...
      if (studentId) {
        // Optimize: Parallelize independent student queries
