...
ipcMain.handle("get-financial-stats", async () => {
  try {
    ...
    const startOfRangeDate = new Date();
    startOfRangeDate.setUTCDate(1);
    startOfRangeDate.setUTCMonth(startOfRangeDate.getUTCMonth() - 5);
    const rangeBoundaries = getMonthBoundaries(startOfRangeDate);
    ...
    `, { replacements: [rangeBoundaries.start] });
