...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    // 1. Exams - dashboard "exams today" optimization
    await queryInterface.addIndex('exams', ['start_time']);

    // 2. Payments - finance views and stats
    await queryInterface.addIndex('payments', ['payment_date']);
    await queryInterface.addIndex('payments', ['type']);

    // 3. Student Exams - progress and dashboard metrics
    ...
    // 4. Lessons - status filtering for dashboard
