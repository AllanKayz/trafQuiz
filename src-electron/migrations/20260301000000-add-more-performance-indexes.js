...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    // 2. Payments - filtered by date and type for financial reports
    await queryInterface.addIndex('payments', ['payment_date']);
    await queryInterface.addIndex('payments', ['type']);

    // 3. Student Exams - heavily used for progress tracking and reports
    ...
    // 4. Lessons - status filtering for dashboard and scheduling
