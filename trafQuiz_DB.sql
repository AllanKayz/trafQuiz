...
(1, 10, '2025-03-18 18:56:25', '2025-07-21 14:56:13');
...
INSERT INTO `instructors` (`id`, `userid`, `name`, `email`, `phone`, `license_number`, `specialization`, `certification`, `experience`, `availability`, `created_at`, `updated_at`) VALUES
(1, 50, 'Keysha Pondo', 'keysha@gmail.com', '+263717834413', '1667555900', 2, 1, 5, 1, '2025-08-31 19:04:51', '2025-08-31 17:04:51');
...
INSERT INTO `students` (`id`, `userid`, `pkgid`, `name`, `email`, `address`, `phone`, `status`, `license_key_id`, `created_at`, `updated_at`) VALUES
(1, 2, 1, 'Letwin Pondo', 'letwin003@gmail.com', '4708 Chiedza Karoi', '+263774833890', 'Active', NULL, '2025-08-16 22:07:24', '2025-08-18 15:33:16'),
(2, 35, 2, 'Asan Kanyemba', 'asankanyemba@gmail.com', '4708 Chiedza, Karoi', '+263717834413', 'active', NULL, '2025-08-18 18:27:57', '2025-08-18 18:27:57'),
(3, 36, 4, 'Allan Kanyemba', 'allankanyemba@gmail.com', '4708 Chiedza, Karoi', '+263717834413', 'active', NULL, '2025-08-18 20:03:49', '2025-08-18 20:03:49');
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `role`, `firstname`, `lastname`) VALUES
(1, 'admin', '$2y$10$mdCKQTJdXgPiTOpPbId1Mu1znniMET5nYfw5vKkc1Ds3PtvvC6roG', 'admin@gmail.com', 'admin', 'admin', 'admin'),
(2, 'student', '$2y$10$mdCKQTJdXgPiTOpPbId1Mu1znniMET5nYfw5vKkc1Ds3PtvvC6roG', 'student@gmail.com', 'student', 'student', 'student'),
(3, 'allankayz', '$2y$10$mdCKQTJdXgPiTOpPbId1Mu1znniMET5nYfw5vKkc1Ds3PtvvC6roG', 'allankanyemba@gmail.com', 'instructor', 'Allan', 'Kanyemba'),
(35, 'asankayz', '$2y$10$Eg7RHqZou0Of91scp4RsjeMmL9eqUYTVfLC8fs0PBxUyl7GJZkeba', '', 'student', '', ''),
(36, 'allankayz', '$2y$10$29hmPayZYhj7PGo7ixLNS.tp1hnLzSq5qznRHKYcGn48X.bb3X47i', '', 'student', '', ''),
(37, 'allankayz', '$2y$10$uzTCc1Yviy4qaygdU44ITOEeu01WWKS449ynjWEFcdJtF5WBGDgz6', '', 'student', '', ''),
(38, 'allankayz', '$2y$10$uGbnI3PJaUkRR3/QgIaQWO8fI7hlKbq1W0CrucCXEWig1RTyRH3DS', '', 'student', '', ''),
(49, 'keysha', '$2y$10$FCUH6XwULHgjfsWedYCFce6plgdKV8mPHrQI2H4kbsCmSm8.X1eLq', '', 'instructor', '', ''),
(50, 'keysha', '$2y$10$qj/BrvxUdecT8fC/uzeQAOCoNLssGOJZ2LgUdhi.Mlbeyf7DSz1i6', '', 'instructor', '', '');
...
CREATE TABLE `vehicles` (
  ...
  `vehicles_status` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `instructors`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_specialization_id` (`specialization`),
  ADD KEY `fk_certification_id` (`certification`),
...
--
ALTER TABLE `instructors`
  ADD CONSTRAINT `fk_certification_id` FOREIGN KEY (`certification`) REFERENCES `certification` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_specialization_id` FOREIGN KEY (`specialization`) REFERENCES `specialization` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `lessons`
  ADD CONSTRAINT `instructor_fk` FOREIGN KEY (`instructor_id`) REFERENCES `instructors` (`id`),
...
--
ALTER TABLE `students`
  ADD CONSTRAINT `fk_packages_id` FOREIGN KEY (`pkgid`) REFERENCES `packages` (`id`),
